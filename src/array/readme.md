...
对数组结构的简单应用，简单了解如何构建数组、设值、取值、克隆数组、遍历数组。

+ 图解

![1534000784764](images/1534000784764.png)

+ 实现代码：[ArrayModel.java](./java/io/github/hooj0/arrays/_01_basic_array/ArrayModel.java)

### 简单自定义数组封装

用数组封装一个`ArrayModel`的Java对象，支持无参构建一个默认 `10`长度的数组，有参构造任意长度的数组。提供判断数组是否为空、获取数组长度、容量等方法。
